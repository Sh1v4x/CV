    ...
    <div class="row">\r
      <div class="col-lg-8">\r
        ...
        <section>\r
          ...
          <article class="bracket">\r
            <h5>Projet ThreeJS-Playground<br /><small>2022</small></h5>\r
...
`;var oe=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,T=(t,e,n,s)=>{for(var r=s>1?void 0:s?ce(e,n):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(r=(s?a(e,n,r):a(r))||r);return s&&r&&oe(e,n,r),r};let y=class extends HTMLElement{constructor(){super(...arguments),this.h1="",this.h2="",this.timeouts=[]}connected(){this.initWriter(),this.initMenu(),typeof screen.orientation<"u"&&(document.addEventListener("mousemove",this.onMouseMove.bind(this)),document.body.addEventListener("mouseleave",this.onMouseMove.bind(this)))}disconnected(){this.timeouts.forEach(t=>clearTimeout(t))}addTimeouts(t){for(this.timeouts=[...this.timeouts,...t];this.timeouts.length>=100;)this.timeouts.shift()}initWriter(){const t={interval:70,replace:!0,update:this.updateH1.bind(this)},e={interval:50,replace:!0,update:this.updateH2.bind(this)},n=()=>this.addTimeouts(u.write(this.h1,"Hello World !",t,()=>this.addTimeouts([setTimeout(s,1e3)]))),s=()=>this.addTimeouts(u.write(this.h1,"</>",t,r)),r=()=>this.addTimeouts(u.write(this.h1,"<I'm Maxime/>",t,()=>this.addTimeouts([setTimeout(i,1e3)]))),i=()=>this.addTimeouts(u.write(this.h1,"I'm Maxime",t,a)),a=()=>this.addTimeouts(u.write(this.h2,"Welcome to my website",e,()=>{this.addTimeouts([setTimeout(l,5e3)]),this.addTimeouts([setTimeout(h,6e3)])})),l=()=>this.addTimeouts(u.write(this.h1,"Maxime",t,o)),o=()=>this.addTimeouts(u.write(this.h1,"Maxime Bomme--Lasnier",t,()=>{this.addTimeouts([setTimeout(p,15e3)]),this.addTimeouts([setTimeout(c,15e3)])})),h=()=>this.addTimeouts(u.write(this.h2,"Web developer",e)),p=()=>this.addTimeouts(u.write(this.h1,"",t,n)),c=()=>this.addTimeouts(u.write(this.h2,"",e));this.addTimeouts([setTimeout(n,0)])}initMenu(){const t=document.querySelector("app-router");this.querySelectorAll("a.page").forEach(e=>{const n=e.getAttribute("href")||"";e.addEventListener("click",s=>{s.preventDefault(),t.navigate(n)})})}updateH1(t){this.h1=t,this.querySelector("h1").innerHTML=t}updateH2(t){this.h2=t,this.querySelector("h2").innerHTML=t}onMouseMove(t){const e=parseInt(document.body.style.getPropertyValue("--mouse-x"))|0,n=parseInt(document.body.style.getPropertyValue("--mouse-y"))|0,s=Math.min(Math.max(-1,(e/window.innerWidth-.5)*2),1),r=Math.min(Math.max(-1,(n/window.innerHeight-.5)*2),1),i=.2,a=-r*i*90,l=s*i*90;this.querySelector(".mouse-oriented").style.transform=`rotateX(${a}deg) rotateY(${l}deg)`}};T([g()],y.prototype,"h1",2);T([g()],y.prototype,"h2",2);y=T([m({selector:"app-header",classes:"w-100 h-100 align-center select-none",template:le})],y);const pe="";var he=Object.defineProperty,de=Object.getOwnPropertyDescriptor,ue=(t,e,n,s)=>{for(var r=s>1?void 0:s?de(e,n):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(r=(s?a(e,n,r):a(r))||r);return s&&r&&he(e,n,r),r};let C=class extends HTMLElement{};C=ue([m({selector:"app-footer",template:pe})],C);const me=`<header class="d-flex justify-content-between">\r
